...
OsGridRef.osGridToLatLongSquare = function (gridref) {
  //  if (!(gridref instanceof OsGridRef))
  //      throw new TypeError('gridref is not OsGridRef object');

    var E1 = Math.floor(gridref.easting / 100) * 100;
    var N1 = Math.floor(gridref.northing / 100) * 100;
    var E2 = E1 + 100;
    var N2 = N1 + 100;
    var g1 = new OsGridRef(E1, N1);
    var g2 = new OsGridRef(E2, N2);
    var ll1 = OsGridRef.osGridToLatLon(g1);
    var ll2 = OsGridRef.osGridToLatLon(g2);
    var southWest = L.latLng(ll1.lat, ll1.lon),
            northEast = L.latLng(ll2.lat, ll2.lon);
           
    var array = [southWest, northEast]; 
    return array;
